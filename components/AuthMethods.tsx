        ...
        <div className="social-container">
          ...
          >
            <div className="btn__icon">
              <Image src={Google} alt="Google logo" fill={true}></Image>
            </div>
          ...
          >
            <div className="btn__icon">
              <Image src={Discord} alt="Discord logo" fill={true}></Image>
            </div>
            <span className="btn__label">Discord</span>
          </button>
          {/* <button type="button" className="btn btn--outline">
            <div className="btn__icon">
              <Image src="/assets/apple.png" alt="Apple logo" fill={true}></Image>
            </div>
